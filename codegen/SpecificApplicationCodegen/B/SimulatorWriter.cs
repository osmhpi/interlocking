...
DEFINITIONS
  ...
  VISB_SVG_UPDATES4== rec(`id`:""W1L2"",fill: IF SCICC_Zone_W1.CurrentOccupancy = OccupancyStatus_VACANT THEN IF SCICC_Transit_W1_L_PLUS_.Active = TRUE or SCICC_Transit_W1_L_MINUS_.Active = TRUE THEN ""green"" ELSE ""gray"" END ELSE ""red"" END);
  VISB_SVG_UPDATES5== rec(`id`:""W2L2"",fill: IF SCICC_Zone_W2.CurrentOccupancy = OccupancyStatus_VACANT THEN IF SCICC_Transit_W2_L_PLUS_.Active = TRUE or SCICC_Transit_W2_L_MINUS_.Active = TRUE THEN ""green"" ELSE ""gray"" END ELSE ""red"" END);
  VISB_SVG_UPDATES6== rec(`id`:""W1R"",fill: IF SCICC_Zone_W1.CurrentOccupancy = OccupancyStatus_VACANT THEN IF SCICC_Transit_W1_R_PLUS_.Active = TRUE or SCICC_Transit_W1_R_MINUS_.Active = TRUE THEN ""green"" ELSE ""gray"" END ELSE ""red"" END,visibility: bool(SCICC_Point_W1.CurrentPosition = EulynxEndPosition_RIGHT));
  VISB_SVG_UPDATES7== rec(`id`:""W2"",fill: IF SCICC_Zone_W2.CurrentOccupancy = OccupancyStatus_VACANT THEN IF SCICC_Transit_W2_L_PLUS_.Active = TRUE or SCICC_Transit_W2_L_MINUS_.Active = TRUE or SCICC_Transit_W2_R_PLUS_.Active = TRUE or SCICC_Transit_W2_R_MINUS_.Active = TRUE THEN ""green"" ELSE ""gray"" END ELSE ""red"" END);
  VISB_SVG_UPDATES8== rec(`id`:""G21"",fill: IF SCICC_Zone_G21.CurrentOccupancy = OccupancyStatus_VACANT THEN IF SCICC_Transit_G21_PLUS_.Active = TRUE or SCICC_Transit_G21_MINUS_.Active = TRUE THEN ""green"" ELSE ""gray"" END ELSE ""red"" END);
  VISB_SVG_UPDATES9== rec(`id`:""W2R"",fill: IF SCICC_Zone_W2.CurrentOccupancy = OccupancyStatus_VACANT THEN IF SCICC_Transit_W2_R_PLUS_.Active = TRUE or SCICC_Transit_W2_R_MINUS_.Active = TRUE THEN ""green"" ELSE ""gray"" END ELSE ""red"" END,visibility: bool(SCICC_Point_W2.CurrentPosition = EulynxEndPosition_RIGHT));
  VISB_SVG_UPDATES10== rec(`id`:""W1L"",fill: IF SCICC_Zone_W1.CurrentOccupancy = OccupancyStatus_VACANT THEN IF SCICC_Transit_W1_L_PLUS_.Active = TRUE or SCICC_Transit_W1_L_MINUS_.Active = TRUE THEN ""green"" ELSE ""gray"" END ELSE ""red"" END,visibility: bool(SCICC_Point_W1.CurrentPosition = EulynxEndPosition_LEFT));
  VISB_SVG_UPDATES11== rec(`id`:""W2L"",fill: IF SCICC_Zone_W2.CurrentOccupancy = OccupancyStatus_VACANT THEN IF SCICC_Transit_W2_L_PLUS_.Active = TRUE or SCICC_Transit_W2_L_MINUS_.Active = TRUE THEN ""green"" ELSE ""gray"" END ELSE ""red"" END,visibility: bool(SCICC_Point_W2.CurrentPosition = EulynxEndPosition_LEFT));
...
END//MACHINE";
  ...
  private static string InitialValueFor(Specification spec, (Interface Interface, InterfaceAssignment Value, EntityType EntityType, string InterfaceInstanceName) i, KeyValuePair<string, InterfaceInputField> input)
  {
    ...
    else if (input.Value.Type == "EulynxEndPosition")
    {
        return "EulynxEndPosition_LEFT";
    }
